...
const VisualizarMaquina = () => {
  ...
  if (!machine) {
    return (
      <Box sx={{ p: 4 }}>
        <Typography>Máquina não encontrada</Typography>
      </Box>
    );
  }
  ...
  return (
    <section className="main-content-box">
      ...
      <div className="content-header-row">
        ...
        <Typography variant="h5" className="machine-title">
        ...
        <div className="left-column">
          <div
            ...
            style={
              machine.imagem
                ? {
                    backgroundImage: `url(${getImageUrl(machine.imagem)})`,
          ...
          <div className="info-gray-card">
            <div className="info-header">
              ...
              <span
                className={`badge-status ${
                  machine.status === 'Regime Saudável'
                    ? 'status-ok'
                    : 'status-warning'
                }`}
              >
            ...
            <Typography variant="body2" color="textSecondary">
              Intensidade de uso: Média
            </Typography>

            <div className="info-sub-row">
              <Typography variant="caption" color="textSecondary">
                Fab: {new Date(machine.data_fabricacao).toLocaleDateString()}
              </Typography>

              <Typography variant="caption" color="textSecondary">
                Nº Série: {machine.num_serie}
              </Typography>
            </div>

            <Typography variant="subtitle2" className="desc-label">
        ...
        <div className="right-column-container">
          <div className="metrics-row">
            <MetricCard
              ...
              label="MTBF Atual"
              value="--"
              footer="Tempo médio entre as falhas"
            />
            <MetricCard
              icon={<SettingsOutlined fontSize="inherit" />}
              label="Manutenções"
              value={metrics.maintenances}
              footer="Últimos 60 dias"
            />
            <MetricCard
          ...
          <Typography variant="subtitle2" className="timeline-label">
            Linha do Tempo:
          </Typography>
      ...
      >
        ...
        >
          ...
          <TextField
            ...
            name="contato_fabricante"
            value={editForm.contato_fabricante || ''}
            onChange={handleEditChange}
            size="small"
            fullWidth
          />
          ...
          <TextField
            ...
            type="date"
            value={editForm.data_fabricacao || ''}
            onChange={handleEditChange}
            size="small"
            fullWidth
      ...
      >
        ...
        <DialogContent>
          <Typography variant="body2">
            Tem certeza que deseja remover a máquina{" "}
            <strong>{machine.nome_maquina}</strong>?
  ...
  <div className="event-item">
    ...
    <div className="event-card">
      ...
      {reportUrl && (
        <a
          href={reportUrl}
          className="timeline-report-link"
          target="_blank"
